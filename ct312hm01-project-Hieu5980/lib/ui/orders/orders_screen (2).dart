...
class _OrdersScreenState extends State<OrdersScreen> {
  ...
  Future<void> _updateStatus(Order order, String status) async {
    try {
      ...
      _load();
      if (status == 'completed') await _checkLowStockAfterComplete();
    } catch (_) {
      if (mounted) {
  ...
  Widget _dishPh(double sz) => Container(
    width: sz,
    height: sz,
    decoration: BoxDecoration(
  ...
  Widget _cartImgPh(double sz) => Container(
    width: sz,
    height: sz,
    decoration: BoxDecoration(
      color: AppColors.gray100,
  ...
  Widget _cartItem({
    ...
    final imgSz = r.isTablet ? 40.0 : 36.0;
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(color: AppColors.primary600.withOpacity(0.15)),
      ),
      child: Row(
        children: [
          ClipRRect(
            ...
            child: url.isNotEmpty
                ? Image.network(
                    ...
                    height: imgSz,
                    fit: BoxFit.cover,
                    errorBuilder: (_, __, ___) => _cartImgPh(imgSz),
                  )
                : _cartImgPh(imgSz),
          ),
          ...
          if (editable && onMinus != null && onPlus != null) ...[
  ...
  // ── Dish list item (dùng trong cả create & detail) ───────────
  Widget _dishListItem({
    required Responsive r,
    required Dish d,
    required String url,
    required int qty,
    ...
    final inCart = qty > 0;
    final imgSz = r.isTablet ? 50.0 : 42.0;
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: inCart ? AppColors.primary600.withOpacity(0.06) : Colors.white,
            ...
            ClipRRect(
              ...
              child: url.isNotEmpty
                  ? Image.network(
                      ...
                      height: imgSz,
                      fit: BoxFit.cover,
                      errorBuilder: (_, __, ___) => _dishPh(imgSz),
                    )
                  : _dishPh(imgSz),
            ),
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: r.sp(12),
                      fontWeight: FontWeight.w600,
                      color: inCart ? AppColors.primary600 : AppColors.gray900,
                    ),
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                  ),
  ...
  Widget _buildSheetLayout({
    ...
    required Widget cartPanel,
    required Widget bottomBar,
    String? errorMsg,
    Widget? filterWidget,
  }) {
    return Container(
      height: r.bottomSheetHeight,
      decoration: const BoxDecoration(
        color: Colors.white,
          ...
          if (errorMsg != null)
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  errorMsg,
                  style: TextStyle(fontSize: r.sp(13), color: AppColors.red700),
                ),
              ),
            ),
  ...
  Future<void> _showCreateOrder() async {
    ...
    await showModalBottomSheet(
      ...
      constraints: r.isTablet
          ? BoxConstraints(maxWidth: 700, maxHeight: r.screenHeight * 0.9)
          : null,
        ...
        builder: (ctx, setS) {
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return _dishListItem(
                            r: r,
                            d: d,
                            url: imgUrl(d.imageUrl),
                            qty: qty,
                            isPending: true,
                            onTap: () {
                              final err = _checkIngredientSufficiency(
                                dishId: dishId,
                                addQty: 1,
                                cart: cart,
                                ingMap: ingMap,
                          ...
                          return _cartItem(
                            ...
                            onPlus: () {
                              ...
                              if (err != null) {
                                ...
                                setS(() => cart[entry.key] = entry.value + 1);
                              }
                            },
                          );
                        }).toList(),
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: AppColors.primary600,
                  foregroundColor: Colors.white,
                  disabledBackgroundColor: AppColors.primary600.withOpacity(
                    0.4,
                  ),
                  shape: RoundedRectangleBorder(
          ...
          final tableForm = Form(
            ...
            child: TextFormField(
              ...
              validator: (v) {
                if (v == null || v.isEmpty) return 'Vui lòng nhập số bàn';
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setS) {
          ...
          Future<void> reloadItems() async {
            final res = await _ordersApi.getById(_id(order.id));
            final od = res.data['data'] ?? res.data;
                                ...
                                return _dishListItem(
                                  ...
                                  onTap: () async {
                                    ...
                                    final existing = items
                                        ...
                                        .firstOrNull;
                                    if (existing != null) {
                                      await _itemsApi.update(_id(existing.id), {
                ...
                child: items.isEmpty
                    ...
                    : ListView(
                        ...
                        children: items.map((it) {
                          final url = imgUrl(dishImages[it.dishId]);
                          return _cartItem(
                            r: r,
                            url: url,
                            name: dishNames[it.dishId] ?? 'Món #${it.dishId}',
                            subtotal: _fmtVnd(it.price * it.quantity),
                            qty: it.quantity,
                            editable: isPending,
                            onMinus: isPending
                                ? () async {
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Container(
                      width: r.isTablet ? 54 : 48,
                      height: r.isTablet ? 54 : 48,
                      decoration: BoxDecoration(
